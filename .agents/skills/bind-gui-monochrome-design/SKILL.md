---
name: bind-gui-monochrome-design
description: Apply Minimalist Monochrome design system to bind-dns-gui components. Uses pure black/white palette, serif typography (Playfair Display), sharp corners, and editorial luxury aesthetics. WHEN: "apply design system", "style with monochrome", "update UI to minimalist", "redesign component", "apply design tokens", "use monochrome palette", "implement editorial design", "update typography", "add design system styles", "refactor CSS to design system".
---
...
**Font Stack**:
- Manrope - for the default font
- Space Grotesk - for heading levels
- Patua One - for logo text
